...
export const portfolioData: PortfolioDetail[] = [
  {
    ...
    `,
    process: `Collaborated with Product Managers and Engineering Managers to develop a comprehensive product requirements document, incorporating current assumptions and quantitative data.<br/><br/>Conducted competitor research and customer interviews to uncover user challenges and experiences, which informed the exploration of multiple design directions.<br/><br/>Designed end-to-end, high-fidelity prototypes and validated them through SEQ-based usability testing to ensure a high level of ease of use.<br/><br/>Partnered with Engineers to translate the solutions into achievable milestones, documenting the process in detailed design specifications, including accessibility (a11y) requirements.`,
    layout: 'default',
    images: [
      {
